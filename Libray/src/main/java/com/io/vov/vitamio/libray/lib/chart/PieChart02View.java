...
public class PieChart02View extends DemoView implements Runnable {
    ...
    private void chartRender() {
        ...
        /*	chart.syncLabelColor();
            ...
            chart.setPadding(0, ltrb[1], 0, ltrb[3]);
    ...
    private void chartDataSet() {
        ...
        //设置图表数据源
        PieData pieData = new PieData("芝麻", "15%", 50, Color.rgb(77, 83, 97));
        pieData.setSelected(true);
        chartData.add(pieData);

        chartData.add(new PieData("白糖", "5%", 50, Color.rgb(75, 132, 1)));
    ...
    public void setPercent() {
        chartData.get(0).setPercentage(70);
        chartData.get(1).setPercentage(30);
    }
