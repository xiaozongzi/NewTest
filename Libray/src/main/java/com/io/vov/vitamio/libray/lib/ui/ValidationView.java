...
/**
 * Created by ${zhangzz} on 2016/7/4.
 */
public class ValidationView extends View {
    ...
    public ValidationView(Context context, AttributeSet attrs, int defStyleAttr) {
...
// 做一些初始化工作
    ...
    public ValidationView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
// 给画笔设置随机颜色
            ...
            canvas.drawText(String.valueOf(mCodeString.charAt(i - 1)), (i-1) * charLength * 1.2f+30, mHeight * 2 / 3f, mTextPaint);
            canvas.restore();
        }
// 产生干扰效果1 -- 干扰点
